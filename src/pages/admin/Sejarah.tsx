...
export default function ASejarah() {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        const data = res.data.find((item: any) => item.judul === "Sejarah");
        setForm({
          id: data?.id ?? null,
          judul: data?.judul ?? "Sejarah",
          isi: data?.isi ?? "",
        });
      })
      .catch((err) => {
          ...
          <div className="md:col-span-9">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden mx-5 md:mx-12">
              <div className="border-b px-6 py-4 bg-gradient-to-r from-blue-900 to-blue-700 text-white">
                <h1 className="text-xl font-semibold">Ubah Konten Sejarah</h1>
              ...
              <div className="p-6 spaceY-5">
                <div className="">
                  ...
                  <input
                    type="text"
                    value={form.judul ? form.judul : "Sejarah"}
