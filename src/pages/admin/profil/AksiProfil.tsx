...
export default function AksiProfil() {
  ...
  const handlePeranChange = (value: string) => {
    setForm((prev) => {
      const exists = prev.peran.includes(value);

      return {
        ...prev,
        peran: exists
          ? prev.peran.filter((item) => item !== value)
          : [...prev.peran, value],
      };
    });
  };
                    ...
                    <div className="w-[400px] md:w-full">
                      ...
                      <div className="border rounded-xl overflow-hidden shadow-sm">
                        ...
                        <label className="flex items-center gap-2">
                          <input
                            type="checkbox"
                            checked={form.peran.includes("Pimpinan Senat")}
                        ...
                        <label className="flex items-center gap-2">
                          <input
                            type="checkbox"
                            checked={form.peran.includes("Pimpinan Fakultas")}
                            onChange={() =>
                        ...
                        <label className="flex items-center gap-2">
                          <input
                            type="checkbox"
                            checked={form.peran.includes("Dosen")}
